            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Product Category 1 for wheelchare,2 canes,3 crutches,4 walkers,5 walking stick,6 Tricycles,7 communication gadgets</label>
                        <input type="number" id="product_type" name="product_type" required="[1-6]" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="">Product Brand 1 for used,2 for ref
                      urbished,3 for new</label>
