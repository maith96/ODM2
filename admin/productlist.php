...
if (isset($_GET['deleteid'])) {
	echo 'Do you really want to delete product with ID of ' . $_GET['deleteid'] . '? <a href="productlist.php?yesdelete=' . $_GET['deleteid'] . '">Yes</a> | <a href="productlist.php">No</a>';
	exit();
}
if (isset($_GET['yesdelete'])) {
	$id_to_delete = $_GET['yesdelete'];
	$sql = mysql_query("DELETE FROM products WHERE product_id='$id_to_delete' LIMIT 1") or die (mysql_error());
